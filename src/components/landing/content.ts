    ...
    process: {
      ...
      rows: [
        ...
        },
        {
          index: "02",
          label: "READ · PARSE",
          title: "Reads the structure of real documents",
          body: "Upstage Document Parse reads the real structure of PDFs, tables, and Korean documents — not just pasted text.",
        },
        {
          index: "03",
          label: "EXTRACT",
